...
$modversion['author'] = "Wishcraft=Simon Roberts<br />Chronolabs Co-op.(http://www.chronolabs.com.au/)" ;
$modversion['credits'] = "Original: Daniel Branco<br />(http://bluetopia.homeip.net)<br />Kazumi Ono<br />(http://www.mywebaddons.com/)<br />The XOOPS Project, Chronolabs Co-op - http://www.chronolabs.com.au/" ;
$modversion['help'] = "" ;
$modversion['license'] = "GPL3 see LICENSE" ;
...
$modversion["blocks"][6]    = array(
    ...
    "template"        => $mydirname."_tag_block_cloud.html",
    );
...
$modversion["blocks"][6]    = array(
    ...
    "options"        => "50|30|c",
    "template"        => $mydirname."_tag_block_top.html",
    );
