...
$GLOBALS['xoops']->header('module:'.$GLOBALS["mydirname"].'|'.$GLOBALS["mydirname"]."_editphoto.html");
$GLOBALS['xoops']->tpl->assign('header', myalbum_header(true)) ;
...
// Show the form
$form = new XoopsThemeForm( _ALBM_PHOTOEDITUPLOAD , "uploadphoto", XOOPS_URL."/modules/".$mydirname."/editphoto.php?lid=$lid" ) ;
...
$GLOBALS['xoops']->tpl->assign( 'editform' , $html ) ;
$GLOBALS['xoops']->tpl->assign( 'footer' , myalbum_footer(true) ) ;
